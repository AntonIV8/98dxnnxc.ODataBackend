...
(
	...
	"contragent" NVARCHAR2(255) NOT NULL,
...
(
	...
	"contragent_id_m0" RAW(16) NOT NULL,
...
(
	...
	"dictionary_id_m0" RAW(16) NOT NULL,
...
(
	...
	"creator_id_m0" RAW(16) NOT NULL,

	"modifier_id" RAW(16) NULL,

	"service_id" RAW(16) NOT NULL,

	"clone_service_id" RAW(16) NULL,
...
(
	...
	"cardinality_m0" RAW(16) NOT NULL,

	"cardinality" RAW(16) NOT NULL,

	"resource_common_id_m0" RAW(16) NOT NULL,

	"parent_service_spec_id_m0" RAW(16) NOT NULL,

	"resource_common_id" RAW(16) NULL,

	"parent_service_spec_id" RAW(16) NULL,
...
(
	...
	"resource_spec_id_m0" RAW(16) NOT NULL,
...
(
	...
	"resource_shared_id_m0" RAW(16) NOT NULL,
...
ALTER TABLE "service_characteristic"
	ADD CONSTRAINT "service_characteristic_Fs_8760" FOREIGN KEY ("service_id_m0") REFERENCES "service" ("primaryKey");

CREATE INDEX "service_characteristic_Is_7989" on "service_characteristic" ("service_id_m0");
...
ALTER TABLE "service"
	ADD CONSTRAINT "service_Fservice_1" FOREIGN KEY ("cfs_id") REFERENCES "service" ("primaryKey");

CREATE INDEX "service_Icfs_id" on "service" ("cfs_id");

ALTER TABLE "service"
	ADD CONSTRAINT "service_Fservice_state_0" FOREIGN KEY ("state") REFERENCES "service_state" ("primaryKey");
...
ALTER TABLE "service"
	ADD CONSTRAINT "service_Fcontragent_0" FOREIGN KEY ("contragent_id_m0") REFERENCES "contragent" ("primaryKey");

CREATE INDEX "service_Icontragent_id_m0" on "service" ("contragent_id_m0");

ALTER TABLE "service"
	ADD CONSTRAINT "service_Fservice_state_1" FOREIGN KEY ("state_m0") REFERENCES "service_state" ("primaryKey");

CREATE INDEX "service_Istate_m0" on "service" ("state_m0");

ALTER TABLE "service"
	ADD CONSTRAINT "service_Fcontragent_1" FOREIGN KEY ("contragent_id") REFERENCES "contragent" ("primaryKey");

CREATE INDEX "service_Icontragent_id" on "service" ("contragent_id");

ALTER TABLE "service"
	ADD CONSTRAINT "service_Fservice_2" FOREIGN KEY ("cfs_id_m0") REFERENCES "service" ("primaryKey");
...
ALTER TABLE "service_spec_characteristic"
	ADD CONSTRAINT "service_spec_characterist_8607" FOREIGN KEY ("service_spec_id") REFERENCES "service_spec" ("primaryKey");

CREATE INDEX "service_spec_characterist_1530" on "service_spec_characteristic" ("service_spec_id");

ALTER TABLE "service_spec_characteristic"
	ADD CONSTRAINT "service_spec_characteristi_327" FOREIGN KEY ("dictionary_id_m0") REFERENCES "dictionary" ("primaryKey");

CREATE INDEX "service_spec_characterist_6278" on "service_spec_characteristic" ("dictionary_id_m0");

ALTER TABLE "service_spec_characteristic"
	ADD CONSTRAINT "service_spec_characteristi_328" FOREIGN KEY ("dictionary_id") REFERENCES "dictionary" ("primaryKey");

CREATE INDEX "service_spec_characterist_1396" on "service_spec_characteristic" ("dictionary_id");

ALTER TABLE "service_spec_characteristic"
	ADD CONSTRAINT "service_spec_characterist_8608" FOREIGN KEY ("service_spec_id_m0") REFERENCES "service_spec" ("primaryKey");
...
ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Forder_state_0" FOREIGN KEY ("state") REFERENCES "order_state" ("primaryKey");

CREATE INDEX "order_item_Istate" on "order_item" ("state");

ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fusr_0" FOREIGN KEY ("creator_id_m0") REFERENCES "usr" ("primaryKey");

CREATE INDEX "order_item_Icreator_id_m0" on "order_item" ("creator_id_m0");

ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fusr_1" FOREIGN KEY ("modifier_id") REFERENCES "usr" ("primaryKey");

CREATE INDEX "order_item_Imodifier_id" on "order_item" ("modifier_id");

ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fservice_2" FOREIGN KEY ("service_id") REFERENCES "service" ("primaryKey");

CREATE INDEX "order_item_Iservice_id" on "order_item" ("service_id");

ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fservice_3" FOREIGN KEY ("clone_service_id") REFERENCES "service" ("primaryKey");

CREATE INDEX "order_item_Iclone_service_id" on "order_item" ("clone_service_id");

ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fusr_2" FOREIGN KEY ("creator_id") REFERENCES "usr" ("primaryKey");
...
ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Forder_state_1" FOREIGN KEY ("state_m0") REFERENCES "order_state" ("primaryKey");
...
ALTER TABLE "service_usage_spec"
	ADD CONSTRAINT "service_usage_spec_Fchara_5384" FOREIGN KEY ("type_m0") REFERENCES "characteristic_type" ("primaryKey");
...
ALTER TABLE "user_group"
	ADD CONSTRAINT "user_group_Fgrp_1" FOREIGN KEY ("group_id_m0") REFERENCES "grp" ("primaryKey");
...
ALTER TABLE "service_order"
	ADD CONSTRAINT "service_order_Fcustomer_0" FOREIGN KEY ("customer_id") REFERENCES "customer" ("primaryKey");

CREATE INDEX "service_order_Icustomer_id" on "service_order" ("customer_id");

ALTER TABLE "service_order"
	ADD CONSTRAINT "service_order_Forder_state_0" FOREIGN KEY ("state_m0") REFERENCES "order_state" ("primaryKey");

CREATE INDEX "service_order_Istate_m0" on "service_order" ("state_m0");

ALTER TABLE "service_order"
	ADD CONSTRAINT "service_order_Forder_state_1" FOREIGN KEY ("state") REFERENCES "order_state" ("primaryKey");

CREATE INDEX "service_order_Istate" on "service_order" ("state");

ALTER TABLE "service_order"
	ADD CONSTRAINT "service_order_Fcustomer_1" FOREIGN KEY ("customer_id_m0") REFERENCES "customer" ("primaryKey");
...
ALTER TABLE "customer_acl"
	ADD CONSTRAINT "customer_acl_Fgrp_0" FOREIGN KEY ("group_id") REFERENCES "grp" ("primaryKey");
...
ALTER TABLE "customer_acl"
	ADD CONSTRAINT "customer_acl_Fcustomer_1" FOREIGN KEY ("customer_id_m0") REFERENCES "customer" ("primaryKey");

CREATE INDEX "customer_acl_Icustomer_id_m0" on "customer_acl" ("customer_id_m0");

ALTER TABLE "customer_acl"
	ADD CONSTRAINT "customer_acl_Fgrp_1" FOREIGN KEY ("group_id_m0") REFERENCES "grp" ("primaryKey");
...
ALTER TABLE "resource_usage_spec"
	ADD CONSTRAINT "resource_usage_spec_Fchar_1577" FOREIGN KEY ("type") REFERENCES "characteristic_type" ("primaryKey");

CREATE INDEX "resource_usage_spec_Itype" on "resource_usage_spec" ("type");

ALTER TABLE "resource_usage_spec"
	ADD CONSTRAINT "resource_usage_spec_Fchar_1578" FOREIGN KEY ("type_m0") REFERENCES "characteristic_type" ("primaryKey");

CREATE INDEX "resource_usage_spec_Itype_m0" on "resource_usage_spec" ("type_m0");

ALTER TABLE "resource_spec"
	ADD CONSTRAINT "resource_spec_Fcardinalit_2605" FOREIGN KEY ("cardinality_m0") REFERENCES "cardinality_type" ("primaryKey");

CREATE INDEX "resource_spec_Icardinality_m0" on "resource_spec" ("cardinality_m0");

ALTER TABLE "resource_spec"
	ADD CONSTRAINT "resource_spec_Fcardinalit_2606" FOREIGN KEY ("cardinality") REFERENCES "cardinality_type" ("primaryKey");

CREATE INDEX "resource_spec_Icardinality" on "resource_spec" ("cardinality");

ALTER TABLE "resource_spec"
	ADD CONSTRAINT "resource_spec_Fresource_c_9601" FOREIGN KEY ("resource_common_id_m0") REFERENCES "resource_common" ("primaryKey");

CREATE INDEX "resource_spec_Iresource_c_7185" on "resource_spec" ("resource_common_id_m0");
...
ALTER TABLE "resource_spec"
	ADD CONSTRAINT "resource_spec_Fresource_c_9602" FOREIGN KEY ("resource_common_id") REFERENCES "resource_common" ("primaryKey");

CREATE INDEX "resource_spec_Iresource_c_5797" on "resource_spec" ("resource_common_id");

ALTER TABLE "resource_spec"
	ADD CONSTRAINT "resource_spec_Fservice_spec_1" FOREIGN KEY ("parent_service_spec_id") REFERENCES "service_spec" ("primaryKey");

CREATE INDEX "resource_spec_Iparent_ser_3613" on "resource_spec" ("parent_service_spec_id");
...
ALTER TABLE "resource_spec_characteristic"
	ADD CONSTRAINT "resource_spec_characteris_6967" FOREIGN KEY ("resource_spec_id_m0") REFERENCES "resource_spec" ("primaryKey");

CREATE INDEX "resource_spec_characteris_5262" on "resource_spec_characteristic" ("resource_spec_id_m0");

ALTER TABLE "resource_spec_characteristic"
	ADD CONSTRAINT "resource_spec_characteris_6968" FOREIGN KEY ("resource_spec_id") REFERENCES "resource_spec" ("primaryKey");
...
ALTER TABLE "resource_spec_characteristic"
	ADD CONSTRAINT "resource_spec_characteris_6529" FOREIGN KEY ("dictionary_id_m0") REFERENCES "dictionary" ("primaryKey");

CREATE INDEX "resource_spec_characteris_7813" on "resource_spec_characteristic" ("dictionary_id_m0");
...
ALTER TABLE "service_spec"
	ADD CONSTRAINT "service_spec_Fservice_spec_0" FOREIGN KEY ("parent_id") REFERENCES "service_spec" ("primaryKey");
...
ALTER TABLE "service_spec"
	ADD CONSTRAINT "service_spec_Fservice_spec_1" FOREIGN KEY ("parent_id_m0") REFERENCES "service_spec" ("primaryKey");

CREATE INDEX "service_spec_Iparent_id_m0" on "service_spec" ("parent_id_m0");

ALTER TABLE "service_spec"
	ADD CONSTRAINT "service_spec_Fcardinality_5215" FOREIGN KEY ("cardinality_m0") REFERENCES "cardinality_type" ("primaryKey");
...
ALTER TABLE "dictionary_value"
	ADD CONSTRAINT "dictionary_value_Fdictionary_1" FOREIGN KEY ("dictionary_id_m0") REFERENCES "dictionary" ("primaryKey");

CREATE INDEX "dictionary_value_Idiction_1146" on "dictionary_value" ("dictionary_id_m0");
...
ALTER TABLE "resource"
	ADD CONSTRAINT "resource_Fservice_0" FOREIGN KEY ("cfs_id_m0") REFERENCES "service" ("primaryKey");
...
ALTER TABLE "resource"
	ADD CONSTRAINT "resource_Fresource_shared_1" FOREIGN KEY ("resource_shared_id_m0") REFERENCES "resource_shared" ("primaryKey");

CREATE INDEX "resource_Iresource_shared_4762" on "resource" ("resource_shared_id_m0");
...
ALTER TABLE "resource"
	ADD CONSTRAINT "resource_Fresource_spec_1" FOREIGN KEY ("resource_spec_id_m0") REFERENCES "resource_spec" ("primaryKey");

CREATE INDEX "resource_Iresource_spec_id_m0" on "resource" ("resource_spec_id_m0");

ALTER TABLE "resource"
	ADD CONSTRAINT "resource_Fservice_2" FOREIGN KEY ("cfs_id") REFERENCES "service" ("primaryKey");
